...
if(isset($this->opt['assign_topics_to_admins']))
{
	if($this->opt['assign_topics_to_admins']=='yes')
	{
		$assign_topics_to_admins_checked_yes=" CHECKED";
		$assign_topics_to_admins_checked_no="";
	}
	else
	{
		$assign_topics_to_admins_checked_yes="";
		$assign_topics_to_admins_checked_no=" CHECKED";
...
echo '<h2>'.$this->lang['option_title_assign_topics_to_admins'].'</h2>';
echo '<div class="'.$this->internal['prefix'].'option_info">'.$this->lang['option_info_assign_topics_to_admins'].'</div>';

echo $this->lang['yes'].' <input type="radio" name="opt[assign_topics_to_admins]" value="yes"'.$assign_topics_to_admins_checked_yes.'>'.$this->lang['no'].' <input type="radio" name="opt[assign_topics_to_admins]" value="no"'.$assign_topics_to_admins_checked_no.'>';
...
echo '<h2>'.$this->lang['option_title_topic_slug'].'</h2>';
echo '<div class="'.$this->internal['prefix'].'option_info">'.$this->lang['option_info_topic_slug'].'</div>';
echo '<input type="text" name="opt[topic_post_type_slug]" value="'.$this->opt['topic_post_type_slug'].'">';


echo '<h2>'.$this->lang['option_title_topic_category_slug'].'</h2>';
echo '<div class="'.$this->internal['prefix'].'option_info">'.$this->lang['option_info_topic_category_slug'].'</div>';
echo '<input type="text" name="opt[topic_category_slug]" value="'.$this->opt['topic_category_slug'].'">';
