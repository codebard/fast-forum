...
AND 
	(
		$this->lang['topic_post_type_slug']!=$this->opt['topic_post_type_slug']
		OR
		$this->lang['topic_post_type_category_slug']!=$this->opt['topic_category_slug']
...
)
{
	...
	echo $this->lang['topic_post_type_slug_change_info'];
...
echo '<form action="admin.php?page=settings_cb_p9&'.$this->internal['prefix'].'tab=languages" name="" method="post" class="'.$this->internal['prefix'].'inline_block_form">';
...
echo '<form action="admin.php?page=settings_cb_p9&'.$this->internal['prefix'].'tab=languages" name="" method="post">';
