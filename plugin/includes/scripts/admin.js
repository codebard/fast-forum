...
jQuery(document).ready(function($) {
	...
	jQuery('body').on("click",'.cb_p9_admin_toggle_button',function(e) {
		target_div = document.getElementById($(this).attr( 'target' ));
		$(target_div).fadeToggle(1800);
	});
	
	jQuery(document).on( 'click', '.cb_p9_notice .notice-dismiss', function(e) {
		...
		jQuery.ajax({
			...
			data: {
				...
				cb_p9_action: 'dismiss_admin_notice',
